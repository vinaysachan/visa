        ...
        <div class="well col-md-8" style="margin:0px 16% ;">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        <td >Image</td>
                        <td ><img src="<?= base_url() . APPLICATION_IMG ?>/<?= $application[0]->image; ?>" class="img-bar" /> </td>

                    </tr>
                    <tr>
                        <td >PassPort</td>
                        <td ><img src="<?= base_url() . PASSPORT_IMG ?>/<?= $application[0]->passport_img; ?>" class="img-bar" /> </td>

                    </tr>
                     <tr>
                        <td >Payment Status</td>
                        <td ><?php $payment_status=$application[0]->payment_status;
                        if($payment_status==1) 
                        {
                            echo "Payment Dome";
                        } else {
