...
<div class="row">
    <label class="col-sm-6 "> Issue Date</label>
    <div class="col-sm-6">
...
<div class="row">
    <label class="col-sm-6 ">Issue Place</label>
    <div class="col-sm-6">
        <?= $apply_details[0]->pass_place_of_Issue; ?>
    </div>
</div>
<div class="row">
    <label class="col-sm-6 ">Issue of Other Passport</label>
    <div class="col-sm-6">
        <?= $apply_details[0]->ic_passport_no; ?>
    </div>
</div>
<div class="row">
    <label class="col-sm-6 ">Country of Issue of Other Passport</label>
    <div class="col-sm-6">
        <?= $apply_details[0]->ic_country_of_Issue; ?>
    </div>
</div>
<div class="row">
    <label class="col-sm-6 "> Other Passport Issue Place</label>
    <div class="col-sm-6">
        <?= $apply_details[0]->ic_place_of_Issue; ?>
    </div>
</div>
<div class="row">
    <label class="col-sm-6 ">Issue Date of Other Passport</label>
    <div class="col-sm-6">
        <?= $apply_details[0]->ic_passport_no; ?>
    </div>
</div>
<div class="row">
    <label class="col-sm-6 ">Nationality Described Therein</label>
    <div class="col-sm-6">
        <?= $apply_details[0]->ic_nationality; ?>
    </div>
</div>
<div class="row">
    <label class="col-sm-6 "> Previous Nationality</label>
    <div class="col-sm-6">
...
<div class="row">
    <label class="col-sm-6 ">Present Address</label>
    <div class="col-sm-6">
...
<div class="row">
    <label class="col-sm-6 ">Postal/Zip Code</label>
    <div class="col-sm-6">
...
<div class="row">
    <label class="col-sm-6 ">Father Name</label>
    <div class="col-sm-6">
        <?= $apply_details[0]->father_name; ?>
    </div>
</div>
<div class="row">
    <label class="col-sm-6 ">Father Nationality</label>
    <div class="col-sm-6">
        <?= $apply_details[0]->father_nationality; ?>
    </div>
</div>
<div class="row">
    <label class="col-sm-6 ">Father Previous Nationality</label>
    <div class="col-sm-6">
        <?= $apply_details[0]->father_prenationality; ?>
    </div>
</div>
<div class="row">
    <label class="col-sm-6 ">Father Place of Birth</label>
    <div class="col-sm-6">
        <?= $apply_details[0]->father_birth_place; ?>
    </div>
</div>
<div class="row">
    <label class="col-sm-6 ">Father Country of Birth</label>
    <div class="col-sm-6">
...
<div class="row">
    <label class="col-sm-6 ">Mother Nationality</label>
    <div class="col-sm-6">
        <?= $apply_details[0]->mother_nationality; ?>
    </div>
</div>
<div class="row">
    <label class="col-sm-6 ">Mother Previous Nationality</label>
    <div class="col-sm-6">
        <?= $apply_details[0]->mother_prenationality; ?>
    </div>
</div>
<div class="row">
    <label class="col-sm-6 ">Mother Place of Birth</label>
    <div class="col-sm-6">
        <?= $apply_details[0]->mother_birth_place; ?>
    </div>
</div>
<div class="row">
    <label class="col-sm-6 ">Mother Country</label>
    <div class="col-sm-6">
...
<div class="row">
    <label class="col-sm-6 ">Spouse Nationality</label>
    <div class="col-sm-6">
...
<div class="row">
    <label class="col-sm-6 ">Spouse Previous Nationality</label>
    <div class="col-sm-6">
        <?= $apply_details[0]->spouse_prenationality; ?>
    </div>
</div>
<div class="row">
    <label class="col-sm-6 ">Spouse Place of Birth</label>
    <div class="col-sm-6">
        <?= $apply_details[0]->spouse_birth_place; ?>
    </div>
</div>
<div class="row">
    <label class="col-sm-6 ">Spouse Country of Birth</label>
    <div class="col-sm-6">
        <?= $apply_details[0]->spouse_birth_country; ?>
    </div>
</div>
<div class="row">
    <label class="col-sm-6 ">Grandparent details yes/no</label>
    <div class="col-sm-6">
        <?= $apply_details[0]->grand_parent_pakistan; ?>
    </div>
</div>
<div class="row">
    <label class="col-sm-6 ">If Yes, give details</label>
    <div class="col-sm-6">
...
<div class="row">
    <label class="col-sm-6 ">Employee Designation</label>
    <div class="col-sm-6">
        <?= $apply_details[0]->Employer_or_business; ?>
    </div>
</div>
<div class="row">
    <label class="col-sm-6 ">Employer Name</label>
    <div class="col-sm-6">
        <?= $apply_details[0]->designation; ?>
    </div>
</div>
<div class="row">
    <label class="col-sm-6 ">Employer Address</label>
    <div class="col-sm-6">
        <?= $apply_details[0]->address; ?>
    </div>
</div>
<div class="row">
    <label class="col-sm-6 ">Employer Phone</label>
    <div class="col-sm-6">
        <?= $apply_details[0]->prof_phone; ?>
    </div>
</div>
<div class="row">
    <label class="col-sm-6 ">Previous Occupation</label>
    <div class="col-sm-6">
        <?= $apply_details[0]->past_occupation; ?>
    </div>
</div>
<div class="row">
    <label class="col-sm-6 ">Security Agency/Organisation</label>
    <div class="col-sm-6">
...
<div class="row">
    <label class="col-sm-6 ">Posting</label>
    <div class="col-sm-6">
...
<div class="row">
    <label class="col-sm-6 ">Visa Type</label>
    <div class="col-sm-6">
        <?= $apply_details[0]->app_type; ?>
    </div>
</div>
<div class="row">
    <label class="col-sm-6 ">No of Entries</label>
    <div class="col-sm-6">
        <?= $apply_details[0]->No_ofentries; ?>
    </div>
</div>
<div class="row">
    <label class="col-sm-6 ">Duration</label>
    <div class="col-sm-6">
        <?= $apply_details[0]->durationofvisa; ?>
    </div>
</div>
<div class="row">
    <label class="col-sm-6 ">Journey Date</label>
    <div class="col-sm-6">
        <?= $apply_details[0]->expected_date_arrival; ?>
    </div>
</div>
<div class="row">
    <label class="col-sm-6 ">Entry Point</label>
    <div class="col-sm-6">
        <?= $apply_details[0]->portofarrival; ?>
    </div>
</div>
<div class="row">
    <label class="col-sm-6 ">Exit Point</label>
    <div class="col-sm-6">
        <?= $apply_details[0]->port_of_exit; ?>
    </div>
</div>
<div class="row">
    <label class="col-sm-6 ">Purpose</label>
    <div class="col-sm-6">
...
<div class="row">
    <label class="col-sm-6 ">Old Visa Issue</label>
    <div class="col-sm-6">
        <?= $apply_details[0]->visited_India; ?>
    </div>
</div>
<div class="row">
    <label class="col-sm-6 ">Old Visa Type</label>
    <div class="col-sm-6">
        <?= $apply_details[0]->visited_type_Visa; ?>
    </div>
</div>
<div class="row">
    <label class="col-sm-6 ">Old Visa No</label>
    <div class="col-sm-6">
        <?= $apply_details[0]->last_Indian_visa_no; ?>
    </div>
</div>
<div class="row">
    <label class="col-sm-6 ">Old Visa Issue Place</label>
    <div class="col-sm-6">
        <?= $apply_details[0]->visited_visa_issue_place; ?>
    </div>
</div>
<div class="row">
    <label class="col-sm-6 ">Old Visa Issue Date</label>
    <div class="col-sm-6">
        <?= $apply_details[0]->visited_visa_issue_date; ?>
    </div>
</div>
<div class="row">
    <label class="col-sm-6 ">Previous Visit Address</label>
    <div class="col-sm-6">
        <?= $apply_details[0]->visited_address; ?>
    </div>
</div>
<div class="row">
    <label class="col-sm-6 ">Visited Cities Details</label>
    <div class="col-sm-6">
        <?= $apply_details[0]->previously_visited_city; ?>
    </div>
</div>
<div class="row">
    <label class="col-sm-6 ">Countries Visited Last 10 year</label>
    <div class="col-sm-6">
...
<div class="row">
    <label class="col-sm-6 ">Name of Sponsor in India</label>
    <div class="col-sm-6">
        <?= $apply_details[0]->ref_name; ?>
    </div>
</div>
<div class="row">
    <label class="col-sm-6 ">Address of Sponsor in India</label>
    <div class="col-sm-6">
        <?= $apply_details[0]->ref_address; ?>
    </div>
</div>
<div class="row">
    <label class="col-sm-6 ">Phone of Sponsor in India</label>
    <div class="col-sm-6">
        <?= $apply_details[0]->ref_phone; ?>
    </div>
</div>
<div class="row">
    <label class="col-sm-6 ">Name of Sponsor in Home Country</label>
    <div class="col-sm-6">
        <?= $apply_details[0]->ref_home_phone; ?>
    </div>
</div>
<div class="row">
    <label class="col-sm-6 ">Address of Sponsor in Home Country</label>
    <div class="col-sm-6">
        <?= $apply_details[0]->ref_home_address; ?>
    </div>
</div>
<div class="row">
    <label class="col-sm-6 ">Phone of Sponsor in Home Country</label>
    <div class="col-sm-6">
        <?= $apply_details[0]->ref_phone; ?>
    </div>
</div>
